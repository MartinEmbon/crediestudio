    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            if (response.data.status === "Error") {
                ...
                await axios.post("https://sendmail-user-loanrequest-589432081267.us-central1.run.app", {
                ...
                // 3️⃣ Guardar en Firestore llamando a la Cloud Function
            await axios.post("https://loan-request-status-589432081267.us-central1.run.app", formData);
                    ...
                    <form onSubmit={handleSubmit} className="loan-form">
                        ...
                        <label>
                            ...
                            <select name="course" value={formData.course} onChange={handleChange} required disabled={!formData.institution}>
                                ...
                                {courses.map((course) => (
                                    <option key={course.id} value={course.name}> {/* Use course.id as the value */}
